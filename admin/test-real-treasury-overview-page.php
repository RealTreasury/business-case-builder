...
<div class="wrap rtbcb-admin-page">
    <h1><?php esc_html_e( 'Test Real Treasury Overview', 'rtbcb' ); ?></h1>

    <div class="card">
        <h2 class="title"><?php esc_html_e( 'Generate Overview', 'rtbcb' ); ?></h2>
        <p><?php esc_html_e( 'Select vendor categories and optionally include portal data.', 'rtbcb' ); ?></p>
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <select id="rtbcb-vendor-categories" multiple style="width: 300px; height: 120px;">
            ...
            <tr>
                <th scope="row">
                    <label for="rtbcb-include-portal-data"><?php esc_html_e( 'Include Portal Data', 'rtbcb' ); ?></label>
                </th>
                <td>
                    <input type="checkbox" id="rtbcb-include-portal-data" />
