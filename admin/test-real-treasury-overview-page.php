    ...
    <div class="card">
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="checkbox" id="rtbcb-include-portal" name="include_portal" value="1" />
            ...
            <tr>
                ...
                <td>
                    <select id="rtbcb-vendor-categories" name="vendor_categories[]" multiple>
                        ...
                        <option value="risk"><?php esc_html_e( 'Risk Management', 'rtbcb' ); ?></option>
                        <option value="analytics"><?php esc_html_e( 'Analytics', 'rtbcb' ); ?></option>
                    </select>
                </td>
            </tr>
        </table>
