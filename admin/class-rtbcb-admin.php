...
class RTBCB_Admin {
    ...
    public function enqueue_admin_assets( $hook ) {
        ...
        wp_localize_script( 'rtbcb-admin', 'rtbcbAdmin', [
            ...
            'strings'  => [
                ...
                'api_success'         => __( 'API connection successful!', 'rtbcb' ),
                'api_failed'          => __( 'API connection failed: ', 'rtbcb' ),
                'rebuilding'          => __( 'Rebuilding...', 'rtbcb' ),
                'rag_success'         => __( 'RAG index rebuilt successfully!', 'rtbcb' ),
                'rag_failed'          => __( 'Failed to rebuild index: ', 'rtbcb' ),
                'exporting'           => __( 'Exporting...', 'rtbcb' ),
                'export_failed'       => __( 'Export failed: ', 'rtbcb' ),
                'unknown_error'       => __( 'Unknown error', 'rtbcb' ),
                'network_error'       => __( 'Network error occurred', 'rtbcb' ),
            ],
        ] );
    }
    ...
    /**
     * Enhanced AJAX handler for generating business cases.
     *
     * @return void
     */
