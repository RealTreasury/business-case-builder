...
class RTBCB_Admin {
    ...
    public function render_leads() {
        $page      = isset( $_GET['paged'] ) ? intval( $_GET['paged'] ) : 1; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
    ...
    public function bulk_action_leads() {
        ...
        $lead_ids = isset( $_POST['lead_ids'] ) ? array_map( 'intval', (array) wp_unslash( $_POST['lead_ids'] ) ) : [];
