    ...
    <form action="options.php" method="post">
        ...
        <table class="form-table" role="presentation">
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" id="rtbcb_enable_ai_analysis" name="rtbcb_enable_ai_analysis" value="1" <?php checked( $enable_ai_analysis, 1 ); ?> />
                    <p class="description"><?php echo esc_html__( 'Run AI-powered analysis when generating reports.', 'rtbcb' ); ?></p>
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <input type="checkbox" id="rtbcb_enable_charts" name="rtbcb_enable_charts" value="1" <?php checked( $enable_charts, 1 ); ?> />
