...
<div class="wrap">
	...
	<p>
		<a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=rtbcb-reports&action=delete_all' ), 'rtbcb_reports_action' ) ); ?>" class="button" onclick="return confirm('<?php echo esc_js( __( 'Are you sure you want to delete all reports?', 'rtbcb' ) ); ?>');"><?php esc_html_e( 'Delete All Reports', 'rtbcb' ); ?></a>
	</p>
