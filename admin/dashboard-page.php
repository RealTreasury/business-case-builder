...
$recent_leads_count = $stats['recent_leads'] ?? 0;
...
// Quick stats
$conversion_rate = $total_leads > 0 ? ( $recent_leads_count / $total_leads ) * 100 : 0;
                            ...
                            <div class="rtbcb-lead-info">
                                ...
                                <div class="rtbcb-lead-meta">
                                    ...
                                    <?php if ( $lead['roi_base'] > 0 ) : ?>
                                        <span class="rtbcb-lead-separator">&bull;</span>
