...
if ( ! function_exists( 'rtbcb_send_report_email' ) ) {
        function rtbcb_send_report_email( $form_data, $url ) {
                global $sent_report_email;
                $sent_report_email = [
                        'form_data' => $form_data,
                        'url'       => $url,
...
global $sent_report_email;
assert_true( isset( $final['report_url'] ), 'report_url missing' );
assert_true( ! empty( $sent_report_email['url'] ), 'Report email not sent' );
