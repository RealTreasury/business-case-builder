...
return array(
    ...
    'RTBCB_Admin_Integration_Test' => $baseDir . '/tests/integration/admin-interface.test.php',
    'RTBCB_Calculator' => $baseDir . '/inc/class-rtbcb-calculator.php',
    'RTBCB_Calculator_Test' => $baseDir . '/tests/unit/calculator-engine.test.php',
    ...
    'RTBCB_OpenAI_Connection_Test' => $baseDir . '/tests/api/openai-connection.test.php',
    'RTBCB_OpenAI_Error_Test' => $baseDir . '/tests/api/openai-error-handling.test.php',
    ...
    'WP_Error' => $baseDir . '/tests/bootstrap/bootstrap.php',
);
