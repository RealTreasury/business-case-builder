...
class RTBCB_LLM {
    ...
    public function generate_real_treasury_overview( $include_portal, $categories ) {
        ...
        $model           = $this->models['mini'] ?? 'gpt-4o-mini';
        $prompt          = 'Provide a treasury overview covering current market landscape, vendor highlights, and key consideratio'
            . 'ns for categories: ' . $categories_list . '. ' . ( $include_portal ? 'Include portal data.' : 'Exclude portal data.' );
