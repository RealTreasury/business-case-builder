...
class RTBCB_Router {
	...
	public static function init() {
	    ...
	    add_filter( 'template_include', [ __CLASS__, 'maybe_render_processing_page' ] );
	}

	/**
	 * Register rewrite endpoint for request processing page.
	 *
	 * @return void
	 */
	public static function register_endpoint() {
	    add_rewrite_endpoint( 'rtbcb-processing', EP_ROOT | EP_PAGES );
	}

	/**
	 * Load request processing template when endpoint is accessed.
	 *
	 * @param string $template Current template path.
	 *
	 * @return string
	 */
	public static function maybe_render_processing_page( $template ) {
	    global $wp_query;
	    if ( isset( $wp_query->query_vars['rtbcb-processing'] ) ) {
	        return RTBCB_DIR . 'templates/request-processing.php';
	    }
	    return $template;
	}
	/**
